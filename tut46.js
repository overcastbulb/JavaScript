...
let reg = /aniruddha/; //This is a regular expression literal in js.
reg = /aniruddha/g; // g means global flag
// reg = /aniruddha/i; // i means case insensitive

// console.log(reg);
// console.log(reg.source);

let s = "This is great code with aniruddha and also aniruddha bhai";
// Functions to match expressions
// 1. exec() - This function will return an array for match or null for no match 
let result = reg.exec(s);
// console.log(result);
// console.log(result.input);
// console.log(result.index); --> We can use multiple exec with global flag
